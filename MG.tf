...
#-------------------------------
resource "azurerm_policy_definition" "Enforce_HTTPS_for_Storage_Account" {
...
resource "azurerm_management_group_policy_assignment" "Enforce_HTTPS_for_Storage_Account" {
  name                 = "EnforceHTTPSStorage"
  display_name         = "Enforce HTTPS for Storage Accounts"
  policy_definition_id = azurerm_policy_definition.Enforce_HTTPS_for_Storage_Account.id
  management_group_id  = azurerm_management_group.PMG.id
